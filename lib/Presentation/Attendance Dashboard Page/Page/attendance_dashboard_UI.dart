                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      String inDate = DateFormat('dd MMMM yyyy')
                                          .format(
                                              parsedDateTime); // "10 January 2025"
                                      String inTime = DateFormat('hh:mm a')
                                          .format(parsedDateTime); // "10:00 AM"
                                        ...
                                        children: [
                                          AttendenceContainers(
                                            ...
                                            approvedby: attendance
                                                ...
                                                .toString(),
                                            approvedDate: inDate,
                                            approverImage: AppImages
                                                .HRImage, // or from data if dynamic
                                          ),
                                          SizedBox(height: 20),
                                        ],
                                      );
                                          ...
                                          children: [
                                            ...
                                            StreamBuilder<int>(
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                String inDate = DateFormat(
                                                        'dd MMMM yyyy')
                                                    .format(
                                                        parsedDateTime); // e.g., "10 January 2025"
                                                String inTime = DateFormat(
                                                        'hh:mm a')
                                                    .format(
                                                        parsedDateTime); // e.g., "10:00 AM"
